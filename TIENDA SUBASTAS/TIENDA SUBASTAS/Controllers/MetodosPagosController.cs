...
namespace asp_servicios.Controllers
{
    ...
    {
        private IMetodosPagosAplicacion? iAplicacion = null;
        private TokenController? tokenController = null;

        public MetodosPagosController(IMetodosPagosAplicacion? iAplicacion, TokenController tokenController)
        {
        ...
        public string Guardar()
        {
            ...
            try
            {
                ...
                var entidad = JsonConversor.ConvertirAObjeto<MetodosPagos>(
