...
namespace asp_servicios.Controllers
{
    ...
    {
        private IVendedoresAplicacion? iAplicacion = null;
        private TokenController? tokenController = null;

        public VendedoresController(IVendedoresAplicacion? iAplicacion, TokenController tokenController)
        {
        ...
        public string Guardar()
        {
            ...
            try
            {
                ...
                var entidad = JsonConversor.ConvertirAObjeto<Vendedores>(
