...
namespace asp_servicios.Controllers
{
    ...
    {
        private IPujasAplicacion? iAplicacion = null;
        private TokenController? tokenController = null;

        public PujasController(IPujasAplicacion? iAplicacion, TokenController tokenController)
        {
        ...
        public string Guardar()
        {
            ...
            try
            {
                ...
                var entidad = JsonConversor.ConvertirAObjeto<Pujas>(
